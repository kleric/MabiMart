				...
				<div class="form-group">
					...
					<div class="col-md-4 col-sm-4">
						<div class="input-group">
							...
							<input type="number" value="{{{ $proficiency }}}" class="form-control">
						</div>
						<br>
					</div>
					@endif
					...
					<div class="col-md-4 col-sm-4">
						<div class="input-group">
							...
							<input type="number" value="{{{$durability }}}" placeholder="Dura." class="form-control">
							<input class="form-control" type="number" placeholder="Max Dura." type="text">
						</div>
						<br>
					</div>
					@endif
