...
<p style="margin: 20px 0;"><a href="{{ $link }}" style="color: #6E5BAA;">{{ $link }}</a>

<p style="margin: 20px 0;">Good luck auctioning, and don't hesitate to contact us with your feedback.</p>

                        <p style="margin: 20px 0;">
                          MabiMart Team<br />
                          <a href="http://mabimart.com" style="color: #6E5BAA;">http://mabimart.com/</a>
                        </p>
                      </td>
                    </tr>
                  </table>
